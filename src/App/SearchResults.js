...
const OneDayForecast = (o) => {
  ...
  return (
    <div role="gridcell" className="text-center p-3 flex-fill text-break text-wrap bg-light p-3 py-md-5  px-1  m-1">
  ...
  return (
    <>
      <div>
        ...
        {!!timezone && <small className="text-muted small">Timezone: {timezone}</small>}
      </div>
